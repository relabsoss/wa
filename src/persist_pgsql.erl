...
try_connect(Params) ->
  ...
  Port = maps:get(port, Params, 5432),
  User = maps:get(user, Params, "wa"),
  Password = maps:get(password, Params, "wa"),
  Database = maps:get(db, Params, "wa"),
